...
exports.ReportsAnalytics = class ReportsAnalytics extends BaseAction {
  ...
  async enterCSVDetails(reportDetails) {
    ...
    if (reportDetails.ownerType) {
      ...
      await this.type(this.elements.ownerDataTypeInput, reportDetails.ownerType);
    ...
    if (reportDetails.dataType) {
      await this.dropdownOptionSelect(`//select[@id="dataType${reportDetails.dataTypeID}"]`, reportDetails.dataType);
    }
