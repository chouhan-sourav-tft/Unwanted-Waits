...
Then('User navigates to {string} tab and select {string}', async (tabName, option) => {
...
Then('user update user setting with following configurations', async (dataTable) => {
...
Then('user access the Agent Quality menu and select {string} tab in {string} window', async (tabName, session) => {
...
Then('user fills E-Learn script with following in {string} window',async(session,scriptDetails)=>{
